...
const POS = () => {
  ...
  // Projected balance for credit payment
 ...
 const handleCheckout = async () => {
  try {
    ...
    // 2️⃣ Create ledger entry if customer exists
    if (selectedCustomer?._id) {
      const ledgerData = {
        customerId: selectedCustomer._id,
        amount: total,
        note: `Sale - Order ID: ${createdOrder._id}`,
        paymentMethod
      };

      console.log("Ledger Payload:", ledgerData); // debug
      await api.post(`/customers/${selectedCustomer._id}/ledger`, ledgerData);
    }
